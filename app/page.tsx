...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const elements = document.querySelectorAll(
      ".scroll-reveal, .stat-card, .category-card, .section-title, .cta-content",
    )
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative w-full min-h-screen bg-hero-pattern overflow-hidden">
        ...
        {/* Scroll indicator */}
        <div className="scroll-indicator absolute bottom-8 left-1/2 text-white">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="section-title text-4xl md:text-5xl font-bold text-gray-800 mb-4">
              {getSectionTitle("categories")}
            </h2>
            <p className="scroll-reveal text-xl text-gray-600 max-w-2xl mx-auto">
              {getSectionDescription("categories")}
            </p>
          </div>
