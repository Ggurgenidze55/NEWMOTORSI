...
Идеален для складов с высокими потолками.`,
        ...
        images: ["/images/tall-warehouse-shelving.jpg"],
...
Специально разработан для эффективного хранения шин.`,
        ...
        images: ["/images/tire-shelving-1.png"],
        colors: [t("blue"), "ნაცარი"],
        sizes: ["200x150x40"],
...
Идеален для эффективной демонстрации одежды.`,
        ...
        images: ["/images/clothing-rack-1.jpg"],
...
Простая установка и использование.`,
        ...
        images: ["/images/aluminum-rail-3.jpg"],
        colors: ["ალუმინი"],
        sizes: ["100x3x2"],
...
Многофункциональный и адаптируемый.`,
        ...
        images: ["/images/perforated-profile-2.jpg"],
...
Идеален для организованной демонстрации товаров.`,
        ...
        images: ["/images/basket-shelving-white.jpeg"],
...
Компактный и эффективный.`,
        ...
        images: ["/images/tier-shelving-red.jpeg"],
