  ...
  const getProductData = (productId: string) => {
    const products = {
      ...
      "warehouse-2": {
        ...
        price: 420.0,
        description: {
          ka: ` თითოეული იარუსი ძლიერია და გათვლილია 300 კილოგრამამდე ტვირთზე, რაც უზრუნველყოფს მძიმე ნივთების უსაფრთხო და სტაბილურ შენახვას. 4 იარუსიანი სტრუქტურა გთავაზობთ პრაქტიკულ განლაგებას, ხოლო 150 სმ სიგანისა და 60 სმ სიღრმის თაროები იდეალურია როგორც ყუთებისთვის, ასევე სხვადასხვა ზომის ტვირთისთვის.
...
ეს მოდელი იდეალურია:
	...
	•	სავაჭრო ობიექტებისთვის
	•	ოფისებისა და არქივებისთვის`,
          en: `Each tier is strong and supports up to 300 kg, ensuring safe and stable storage of heavy items. The 4-tier design offers a practical layout, while the 150 cm wide and 60 cm deep shelves are ideal for boxes and various-sized loads.
...
This model is ideal for:
	...
	•	Retail environments
	•	Offices and archives`,
          ru: `Каждый ярус прочный и рассчитан на нагрузку до 300 кг, что обеспечивает безопасное и устойчивое хранение тяжёлых предметов. Конструкция с 4 ярусами предлагает практичное расположение, а полки шириной 150 см и глубиной 60 см идеально подходят как для коробок, так и для грузов разных размеров.
